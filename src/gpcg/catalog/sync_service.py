...
class SyncService:
    ...
    def _update_catalog_game(self, existing: CatalogGame, igdb: IGDBGame) -> None:
        ...
        existing.storyline = igdb.storyline
        existing.first_release_date = igdb.first_release_date
        existing.rating = igdb.rating
        existing.rating_count = igdb.rating_count
        existing.total_rating = igdb.total_rating
        existing.total_rating_count = igdb.total_rating_count
        existing.hypes = igdb.hypes
        existing.category = igdb.category
        existing.cover_url = igdb.cover_url
        existing.screenshots = igdb.screenshot_urls
        existing.genres = igdb.genres
        existing.themes = igdb.themes
        existing.game_modes = igdb.game_modes
        existing.player_perspectives = igdb.player_perspectives
        existing.platforms = igdb.platforms
        existing.franchise = igdb.franchise
        existing.developer = igdb.developer
        existing.publisher = igdb.publisher
        existing.igdb_url = igdb.igdb_url
