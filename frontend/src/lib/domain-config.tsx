...
export const DOMAIN_CONFIGS: Record<string, DomainConfig> = {
  games: {
    ...
    navigation: [
      ...
      { to: "/content", label: "nav.content", icon: "FileText" },
      { to: "/ideas", label: "nav.ideas", icon: "Lightbulb" },
      { to: "/jobs", label: "nav.jobs", icon: "ListChecks" },
      { to: "/automation", label: "nav.automation", icon: "Settings" },
  ...
  kids: {
    ...
    navigation: [
      { to: "/dashboard", label: "nav.dashboard", icon: "LayoutDashboard" },
      { to: "/kids", label: "nav.topics", icon: "Baby" },
      { to: "/kids-ideas", label: "nav.ideas", icon: "Lightbulb" },
      { to: "/jobs", label: "nav.jobs", icon: "ListChecks" },
      { to: "/automation", label: "nav.automation", icon: "Settings" },
      { to: "/videos", label: "nav.videos", icon: "Video" },
    ],
